...
The Auto Analysis App allows the user to manipulate an interactive plot of Auto data to better understand the correlations between the 6 automotive variables including mpg,cylinders,horsepower,weight,year,and acceleration. The output for this application is a multifaceted analysis based on the user's selected inputs. 

## Data Source

This data set was taken from the StatLib library which is maintained at Carnegie Mellon University. The data set was used in the 1983 American Statistical Association Exposition and included in the book "An Introduction to Statistical Learning" (James, Witten, Hastie and Tibshirani, 2013).  
